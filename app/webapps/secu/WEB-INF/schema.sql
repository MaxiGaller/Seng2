...
insert into LatexSniped (id, muser_id, document_id, content, content_type) VALUES (NULL, 2, 0, 'Dolor Sit Amet Dolor Sit Amet Dolor Sit Amet Dolor Sit Amet ', 1);
insert into LatexSniped (id, muser_id, document_id, content, content_type) VALUES (NULL, 2, 0, 'Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum', 3);
insert into LatexSniped (id, muser_id, document_id, content, content_type) VALUES (NULL, 2, 0, 'Dolor Sit Amet Dolor Sit Amet Dolor Sit Amet Dolor Sit Amet ', 2);
insert into LatexSniped (id, muser_id, document_id, content, content_type) VALUES (NULL, 2, 0, 'Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem IpsumLorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem IpsumLorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum', 3);
insert into LatexSniped (id, muser_id, document_id, content, content_type) VALUES (NULL, 2, 1, 'H1 H1 H1 H1 H1', 0);
insert into LatexSniped (id, muser_id, document_id, content, content_type) VALUES (NULL, 2, 1, 'TEXT TEXT TEXT', 3);
insert into LatexSniped (id, muser_id, document_id, content, content_type) VALUES (NULL, 2, 1, 'H2 H2 H2 H2 H2', 1);
insert into LatexSniped (id, muser_id, document_id, content, content_type) VALUES (NULL, 2, 1, 'TEXT TEXT TEXT', 3);
insert into LatexSniped (id, muser_id, document_id, content, content_type) VALUES (NULL, 2, 1, 'H3 H3 H3 H3 H3', 2);
